#
# Be sure to run `pod lib lint QFStatistics.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'Pod/Frameworks/**/*.{h,m}'
  s.vendored_frameworks = "**/*.framework"
  s.preserve_paths = "**/*.framework"
  s.resources    = "**/*.bundle"

  # s.resource_bundles = {
  #   'QFStatistics' => ['QFStatisticsSDK/Assets/*.png']
  # }

    s.public_header_files = 'Pod/Frameworks/Header/*.h'
